...
def Send():
        ...
        frame4 = Frame(root,width=300,height=60,relief=RIDGE,borderwidth=5,bg='#2a094f',highlightbackground="white", highlightcolor="white", highlightthickness=2)
        frame4.place(x=0,y=0)
                
        l2 = Label(frame4,text="SEND BILL",font=('calibri',20,'bold'),bg='#2a094f',fg="#d9c241")
        l2.place(x=85,y=1)

        frame5 = Frame(root,width=300,height=340,relief=RIDGE,borderwidth=5,bg='#2a094f',highlightbackground="white", highlightcolor="white", highlightthickness=2)
        frame5.place(x=0,y=55)

        innerframe5 = Frame(frame5,width=285,height=325,relief=RIDGE,borderwidth=3,bg='#2a094f',highlightbackground="white", highlightcolor="white", highlightthickness=2)        
        innerframe5.place(x=0,y=0)

        l3 = LabelFrame(innerframe5,text="Send Bill Through SMS",width=270,height=310,borderwidth=3,font=('comic sans',10,'bold'),fg='#2a094f',relief=RIDGE,highlightbackground="white", highlightcolor="white", highlightthickness=2)
        l3.place(x=2,y=2)

        l4 = Label(innerframe5,text="Phone Number",font=('comic sans',10,'bold'))
        l4.place(x=40,y=40)

        number = Entry(innerframe5,width=30,borderwidth=2)
        number.place(x=40,y=70)
        
        l5 = Label(innerframe5,text="Bill Details",font=('comic sans',10,'bold'))
        l5.place(x=40,y=100)
        ...
        def send_bill():
                ...
                if ph_number == "":
                        ...
                        api="AI4tA0GiepiT3Ht54sTkk9smKM8JskDL34hZ9nU0irBddbX3SQ0sSf7OCPdn" 
                        ...
                        messagebox.showinfo("Send SMS",'Bill has been send to your number successfully')

                
        send_msg = Button(innerframe5,text="Send Bill",relief=RAISED,borderwidth=2,font=('comic sans',8,'bold'),bg='#2a094f',fg="white",padx=20,command=send_bill)
...
def Send():
        ...
        l2 = Label(frame4,text="Send Bill",font=('roboto',22,'bold'),bg='#2a094f',fg="#ffffff")
        l2.place(x=85,y=1)
...
def feedback():
        ...
        l2 = Label(frame4,text="    YOUR FEEDBACK",font=('calibri',20,'bold'),bg='#2a094f',fg="#d9c241")
        l2.place(x=20,y=1)
        ...
        l3 = LabelFrame(innerframe5,text="Submit your Feedback",width=270,height=310,borderwidth=3,font=('comic sans',10,'bold'),fg='#2a094f',relief=RIDGE,highlightbackground="white", highlightcolor="white", highlightthickness=2)
        l3.place(x=2,y=2)

        l4 = Label(innerframe5,text="Text",font=('comic sans',10,'bold'))
        l4.place(x=40,y=40)

        text = Entry(innerframe5,width=30,borderwidth=2)
        ...
        def submit_feedback():
                ...
                messages = b_detail.get("1.0","end-1c")
                if feedback == "":
                        messagebox.showerror("Error",'Please give your feedback')
                elif messages == "":
                        messagebox.showerror("Error",'Bill Details is empty')
                else:
                        messagebox.showinfo("Submit",'Thanks for your feedback')
        submit = Button(innerframe5,text="Submit",relief=RAISED,borderwidth=2,font=('comic sans',8,'bold'),bg='#2a094f',fg="white",padx=20,command=submit_feedback)
        submit.place(x=100,y=255)
...
root.maxsize(700,390)
root.minsize(700,390)
root.title("Restaurant Management System")

frame = Frame(root,width=700,height=70,relief=RIDGE,borderwidth=5,bg='#2a094f')
frame.place(x=0,y=0)

l1 = Label(frame,text="          RESTAURANT MANAGEMENT SYSTEM",font=('calibri',24,'bold'),bg='#2a094f',fg="#d9c241")
l1.place(x=10,y=4)


# ======================================================================

frame1= Frame(root,width=450,height=230,relief=RIDGE,borderwidth=5,bg='#2a094f')
frame1.place(x=0,y=70)

innerframe1 = Frame(frame1,width=150,height=220,relief=RIDGE,borderwidth=3,bg='#2a094f',highlightbackground="white", highlightcolor="white", highlightthickness=2)        
innerframe1.place(x=0,y=0)

drinks  = LabelFrame(innerframe1,text="DRINKS",width=135,height=205,borderwidth=3,font=('comic sans',10,'bold'),fg='#2a094f',relief=RIDGE,highlightbackground="white", highlightcolor="white", highlightthickness=2)
drinks.place(x=2,y=2)



lassi_var = IntVar()
lassi = Checkbutton(drinks,text="Lassi",variable=lassi_var,font=('comic sans',8,'bold'),onvalue=1,offvalue=0,command=lassi_chk)
lassi.place(x=2,y=2)
...
coffee_var = IntVar()
coffee = Checkbutton(drinks,text="Coffee",variable=coffee_var,font=('comic sans',8,'bold'),onvalue=1,offvalue=0,command=coffee_chk)
...
tea_var = IntVar()
tea = Checkbutton(drinks,text="Tea",variable=tea_var,font=('comic sans',8,'bold'),onvalue=1,offvalue=0,command=tea_chk)
tea.place(x=2,y=44)
tea_qty = Entry(drinks,width=7,borderwidth=4,relief=SUNKEN,state="disabled")
tea_qty.place(x=74,y=44)

juice_var = IntVar()
juice = Checkbutton(drinks,text="Juice",variable=juice_var,font=('comic sans',8,'bold'),onvalue=1,offvalue=0,command=juice_chk)
juice.place(x=2,y=66)
juice_qty = Entry(drinks,width=7,borderwidth=4,relief=SUNKEN,state="disabled")
juice_qty.place(x=74,y=66)

shakes_var = IntVar()
shakes = Checkbutton(drinks,text="Shakes",variable=shakes_var,font=('comic sans',8,'bold'),onvalue=1,offvalue=0,command=shakes_chk)
...
milk_var = IntVar()
milk = Checkbutton(drinks,text="Milk",variable=milk_var,font=('comic sans',8,'bold'),onvalue=1,offvalue=0,command=milk_chk)
milk.place(x=2,y=110)
milk_qty = Entry(drinks,width=7,borderwidth=4,relief=SUNKEN,state="disabled")
milk_qty.place(x=74,y=110)

shikanji_var = IntVar()
shikanji = Checkbutton(drinks,text="Shikanji",variable=shikanji_var,font=('comic sans',8,'bold'),onvalue=1,offvalue=0,command=shikanji_chk)
...
redbull_var = IntVar()
redbull = Checkbutton(drinks,text="Redbull",variable=redbull_var,font=('comic sans',8,'bold'),onvalue=1,offvalue=0,command=redbull_chk)
...
innerframe2 = Frame(frame1,width=290,height=220,relief=RIDGE,borderwidth=3,bg='#2a094f',highlightbackground="white", highlightcolor="white", highlightthickness=2)        
innerframe2.place(x=151,y=0)


foods  = LabelFrame(innerframe2,text="FOODS",width=275,height=205,borderwidth=3,font=('comic sans',10,'bold'),fg='#2a094f',relief=RIDGE,highlightbackground="white", highlightcolor="white", highlightthickness=2)
foods.place(x=2,y=2)

roti_var = IntVar()
roti = Checkbutton(foods,text="Roti",variable=roti_var,font=('comic sans',8,'bold'),command=roti_chk)
roti.place(x=2,y=2)
roti_qty = Entry(foods,width=15,borderwidth=4,relief=SUNKEN,state="disabled")
roti_qty.place(x=140,y=2)

dal_makhni_var = IntVar()
dal_makhni = Checkbutton(foods,text="Dal Makhni",variable=dal_makhni_var,font=('comic sans',8,'bold'),command=dal_makhni_chk)
...
mutter_panner = Checkbutton(foods,text="Mutter Panner",variable=mutter_panner_var,font=('comic sans',8,'bold'),command=mutter_panner_chk)
...
paratha_var = IntVar()
paratha = Checkbutton(foods,text="Paratha",variable=paratha_var,font=('comic sans',8,'bold'),command=paratha_chk)
...
mix_veg_var = IntVar()
mix_veg = Checkbutton(foods,text="Mix Veg",variable=mix_veg_var,font=('comic sans',8,'bold'),command=mix_veg_chk)
...
omelete_var = IntVar()
omelete = Checkbutton(foods,text="Omelete",variable=omelete_var,font=('comic sans',8,'bold'),command=omelete_chk)
...
veg_biryani = Checkbutton(foods,text="Veg Biryani",variable=veg_biryani_var,font=('comic sans',8,'bold'),command=veg_biryani_chk)
...
rice_var = IntVar()
rice = Checkbutton(foods,text="Rice",variable=rice_var,font=('comic sans',8,'bold'),command=rice_chk)
...
frame2= Frame(root,width=450,height=90,relief=RIDGE,borderwidth=5,bg='#2a094f')
frame2.place(x=0,y=300)

innerframe3 = Frame(frame2,width=440,height=80,relief=RIDGE,borderwidth=3,bg='#2a094f', highlightbackground="white", highlightcolor="white", highlightthickness=2)        
innerframe3.place(x=0,y=0)


cost_of_drinks = Label(innerframe3,text="COST OF DRINKS",font=('comic sans',8,'bold'))
...
cost_of_foods = Label(innerframe3,text="COST OF FOOD'S",font=('comic sans',8,'bold'))
cost_of_foods.place(x=2,y=24)
foods_cost = Entry(innerframe3,width=13,borderwidth=4,relief=SUNKEN)
foods_cost.place(x=130,y=22)

service_charge = Label(innerframe3,text="SERVICE CHARGE",font=('comic sans',8,'bold'))
...
paid_tax = Label(innerframe3,text="PAID TAX",font=('comic sans',8,'bold'))
...
sub_total = Label(innerframe3,text="SUB TOTAL",font=('comic sans',8,'bold'))
...
total_cost = Label(innerframe3,text="TOTAL COST",font=('comic sans',8,'bold'))
...
#============================================================================
frame3= Frame(root,width=240,height=320,relief=RIDGE,borderwidth=5,bg='#2a094f')
frame3.place(x=450,y=70)

innerframe4 = Frame(frame3,width=240,height=310,relief=RIDGE,borderwidth=3,bg='#2a094f',highlightbackground="white", highlightcolor="white", highlightthickness=2)        
innerframe4.place(x=0,y=0)


result = Entry(innerframe4,width=32,relief=SUNKEN,borderwidth=3)
result.place(x=13,y=0)

nine = Button(innerframe4,text="9",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#2a094f',fg="white",command=nine)
nine.place(x=22,y=24)
eight = Button(innerframe4,text="8",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#2a094f',fg="white",command=eight)
eight.place(x=70,y=24)
seven = Button(innerframe4,text="7",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#2a094f',fg="white",command=seven)
seven.place(x=118,y=24)
plus = Button(innerframe4,text="+",padx=6,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='white',fg="black",command=plus)
plus.place(x=166,y=24)


six = Button(innerframe4,text="6",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#2a094f',fg="white",command=six)
six.place(x=22,y=50)
five = Button(innerframe4,text="5",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#2a094f',fg="white",command=five)
five.place(x=70,y=50)
four = Button(innerframe4,text="4",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#2a094f',fg="white",command=four)
four.place(x=118,y=50)
minus = Button(innerframe4,text="-",padx=8,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='white',fg="black",command=minus)
minus.place(x=166,y=50)

three = Button(innerframe4,text="3",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#2a094f',fg="white",command=three)
three.place(x=22,y=76)
two = Button(innerframe4,text="2",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#2a094f',fg="white",command=two)
two.place(x=70,y=76)
one = Button(innerframe4,text="1",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#2a094f',fg="white",command=one)
one.place(x=118,y=76)
multiply = Button(innerframe4,text="*",padx=7,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='white',fg="black",command=mul)
multiply.place(x=166,y=76)

zero = Button(innerframe4,text="0",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#2a094f',fg="white",command=zero)
zero.place(x=22,y=102)
clear = Button(innerframe4,text="C",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#2a094f',fg="white",command=clear)
clear.place(x=70,y=102)
equal = Button(innerframe4,text="=",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#2a094f',fg="white",command=equal)
equal.place(x=118,y=102)
divide = Button(innerframe4,text="/",padx=7,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='white',fg="black",command=divide)
divide.place(x=166,y=102)


bill_details = ScrolledText(innerframe4,width=23,height=9,relief=SUNKEN,borderwidth=3,font=('courier',9,''))
bill_details.place(x=20,y=130)


total = Button(innerframe4,text="Total",relief=RAISED,borderwidth=2,font=('comic sans',8,'bold'),bg='#2a094f',fg="white",command=total_bills)
total.place(x=0,y=275)

save = Button(innerframe4,text="Save",relief=RAISED,borderwidth=2,font=('comic sans',8,'bold'),bg='#2a094f',fg="white",command=save)
save.place(x=43,y=275)

send = Button(innerframe4,text="Send",relief=RAISED,borderwidth=2,font=('comic sans',8,'bold'),bg='#2a094f',fg="white",command=Send)
send.place(x=85,y=275)

exit = Button(innerframe4,text="Exit",relief=RAISED,borderwidth=2,font=('comic sans',8,'bold'),bg='#2a094f',fg="white",command=exit)
exit.place(x=130,y=275)

clr = Button(innerframe4,text="C",relief=RAISED,borderwidth=2,font=('comic sans',8,'bold'),bg='#2a094f',fg="white",command=cleared_bill)
clr.place(x=166,y=275)

sub = Button(innerframe4,text="Rate",relief=RAISED,borderwidth=2,font=('comic sans',8,'bold'),bg='#2a094f',fg="white",command=feedback)
sub.place(x=190,y=275)
